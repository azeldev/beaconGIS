...
**Method**: AI-assisted draft via the beaconGIS QGIS plugin (Siamese U-Net ensemble, xView2/xBD)
**Severity tier**: {severity}
...
# Backwards-compatible alias for callers that still import LLMAssistantDock.
LLMAssistantDock = AssessmentReportsDock
